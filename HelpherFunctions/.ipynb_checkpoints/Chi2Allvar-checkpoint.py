...
def mylikelihoodAV(Cqu1,Cqt8,Cqtqb1,Cqtqb8,CH,data,experiments=['ATLAS','CMS'],HiggsChannels=['ggf','vbf','ttxh','vh'],TopChannels=None,mode='fin',l3mode='linear',linearmu=True):
...
###########################################################################
   ...
   (delta_ch_vbf**2+delta_ch_ww**2)**.5,\
    ...
    errtthTheo = np.array([(delta_ch_tth**2+delta_ch_gaga**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
    (delta_ch_tth**2+delta_ch_vhdecay**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
                           0.,\
    (delta_ch_tth**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
    (delta_ch_tth**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,0\
        ])
    errtthhlTheo = np.array([(delta_ch_tth**2+delta_ch_gaga**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
    (delta_ch_tth**2+delta_ch_zz**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
    (delta_ch_tth**2+delta_ch_ww**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
    (delta_ch_tth**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
    (delta_ch_tth**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,0\
        ])
    errtthTheocms = np.array([(delta_ch_tth**2+delta_ch_gaga**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
    (delta_ch_tth**2+delta_ch_vhdecay**2+data['Cqt1']['ttH_delta_'+mode]**2)**.5,\
                           0.,0.,0.,\
        ])
    muth1={
