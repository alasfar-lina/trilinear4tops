...
runs=500000
################################
ll = lambda c4q,ch : mylikelihoodAV(0,c4q,0,0,ch,data,collider='Run-II',mode='rge',l3mode='linear')
...
print('done')
##############################################################
ll1 = lambda c4q,ch : mylikelihoodAV(0,c4q,0,0,ch,data,collider='Run-II',mode='rge',l3mode='quadratic')
